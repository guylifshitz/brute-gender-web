...
set :linked_files, %w{scripts/lexique-dicollecte-fr-v6.0.2.csv scripts/GLAWI_FR_workParsed_D2015-12-26_R2016-05-18.xml scripts/word_counts_ngrams.csv .env.production}
